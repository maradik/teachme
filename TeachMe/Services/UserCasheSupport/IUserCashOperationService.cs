...
namespace TeachMe.Services.UserCasheSupport
{
    public interface IUserCashOperationService
    {
        ...
        void RevertTransferMoneyFromUserToUser(string sourceUserId, string recipientUserId, double amount, double commissionAmount, TransactionType transactionType, string transactionDescription);
